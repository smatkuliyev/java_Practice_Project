...
public class A_StringMethods {
    public static void main(String[] args) {
        ...
        /** lastIndexOf()
         *  String icinde aranan karakter(ler)in sondan itibaren ilk indexini varir
        ...
        System.out.println("ilk bastan i nun indexi = " + textt.indexOf("i")); //6
        System.out.println("----------");
        /**
         * charAt()
         * İstenen noktadaki karakteri verir,
         * karakterlerin sirasi 0 dan baslar, buna index denir.
        ...
        * Replace ile ayni sadece ilk bulunani degistirir
        ...
        System.out.println("butun a larin nin degistigi hali = " + txt.replace("a", "e"));
        // butun a larin nin degistigi hali = Merhebe Dunye
        System.out.println("ilk bulunan a nin degistigi hali = " + txt.replaceFirst("a", "e"));
        // ilk bulunan a nin degistigi hali = Merheba Dunya
        System.out.println("----------");
        /** replaceAll()
         *
         */
         ...
         *
         * equals()
         * 2 String metnin birbirine esit olup olmadigina bakar. buyuk kucuk harf farki vardir. Sonuc boolean dir.
         *
         * equalsIgnorecase()
        ...
        System.out.println("Esit mi = " + str.equalsIgnoreCase("mERHaba")); // true
        System.out.println("Esit mi = " + str.equalsIgnoreCase("mERHa")); // false
    ...
    * bir stringe digerini ekler
     ...
     * */
        ...
        s = s.concat(s2);// yani degiskenin kendisine atama yapilirsa degeri kalici degisir.
        // s= s+s2; ayni islemi yapar.
        System.out.println("s = " + s); // s = Hi everybody
        System.out.println("----------");
        /**
         * StringIsEmpty
         *  String tamamen bos mu degil mi onu kontrol ediyor, sonuc true false
         */
        String str1 = "Hi";
        System.out.println("str1 ici bos mu = " + str1.isEmpty()); //false

        String str2 = "";
        System.out.println("str2 ici bos mu = " + str2.isEmpty()); //true

        String str3 = " ";
        System.out.println("str3 ici bos mu = " + str3.isEmpty());  //false
