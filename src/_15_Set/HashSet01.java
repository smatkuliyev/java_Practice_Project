...
public class HashSet01 {
    /*
     Set : 1) unique(benzersiz tek) elemanlardan olusur, Set'lerin icinde bir eleman sadece bir kere kullanilabilir. mukerrer(duplicate) eleman olmaz.
            2) sadece bir null degeri alabilir.(treeSet haric).Java elementleri unique yapmak icin HASH ALGORITMASI kullanir.
            ...
            Set     --> HashSet         : 1) HashSet, duplication'a(tekrarli eleman) izin vermez.
                                            Eger bir elemani tekrar HashSet'e eklemek isterseniz eski olan silinip, yeni olan uzerine yazilir.
                                          2) Haset'ler Set'ler arasinda en hizli olanidir. bir algoritmaya gore kayit eder.
         ...
         Set Methods :
            ...
            .equals(set2);-->istenen set2'le tum elemanlar ayni ise true, yoksa false dondurur
            .retainAll(collection1);-->collection1'nin elemanlarinin disindaki tum elemanlari siler, silme islemi yapti ise true, yoksa false dondurur(kesisen ortak elemanlari dondurur.)
